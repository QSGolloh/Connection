        ...
        foreach ($codeLines as $line) {
            ...
            if (array_key_exists($i, $coverageData)) {
                ...
                if ($coverageData[$i] === null) {
                    ...
                    $lineCss        = 'covered-by-large-unit';
                    $popoverContent = '<ul>';

                    if ($numTests > 1) {
                        $popoverTitle = $numTests . ' unit cover line ' . $i;
                    } else {
                        $popoverTitle = '1 test covers line ' . $i;
                    }

                    foreach ($coverageData[$i] as $test) {
                        if ($lineCss == 'covered-by-large-unit' && $testData[$test]['size'] == 'medium') {
                            $lineCss = 'covered-by-medium-unit';
                        } elseif ($testData[$test]['size'] == 'small') {
                            $lineCss = 'covered-by-small-unit';
                        }
                        ...
                        switch ($testData[$test]['status']) {
                            case 0:
                                switch ($testData[$test]['size']) {
                                    case 'small':
                                        $testCSS = ' class="covered-by-small-unit"';
                                        break;

                                    case 'medium':
                                        $testCSS = ' class="covered-by-medium-unit"';
                                        break;

                                    default:
                                        $testCSS = ' class="covered-by-large-unit"';
                                        break;
                                }
                                break;
