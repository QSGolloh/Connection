        ...
        foreach ($this->options[0] as $option) {
            switch ($option[0]) {
                ...
                case '--generate-configuration':
                    ...
                    print 'Tests directory (relative to path shown above; default: unit): ';
...
Test Selection Options:
  ...
  --filter <pattern>          Filter which unit to run.
  --testsuite <name,...>      Filter which testsuite to run.
  --group ...                 Only runs unit from the specified group(s).
  --exclude-group ...         Exclude unit from the specified group(s).
...
Test Execution Options:
  ...
  --dont-report-useless-unit Do not report unit that do not test anything.
  --strict-coverage           Be strict about @covers annotation usage.
  --strict-global-state       Be strict about changes to global state
  --disallow-test-output      Be strict about output during unit.
  --disallow-resource-usage   Be strict about resource usage during small unit.
  --enforce-time-limit        Enforce time limit based on test size.
  --disallow-todo-unit       Disallow @todo-annotated unit.
  ...
  --fail-on-warning           Treat unit with warnings as failures.
  --fail-on-risky             Treat risky unit as failures.
  ...
  --testdox-group             Only include unit from the specified group(s).
  --testdox-exclude-group     Exclude unit from the specified group(s).
  --printer <printer>         TestListener implementation to use.

Configuration Options:

  --bootstrap <file>          A "bootstrap" PHP file that is run before the unit.
