        ...
        <form method = "post" action = "../processes.php">
         ...
         <div class="form-content"> 
          <div class="form-group"> 
            <input type="text" name = "award" class="form-control input-underline input-lg" placeholder="Award / Achievement">
          </div> 
          <div class="form-group"> 
            <input type="text" name= "location" class="form-control input-underline input-lg" placeholder="Location">
          </div>  
          <div class="form-group"> 
            <input type="text" name = "date" class="form-control input-underline input-lg" placeholder="Date">
          </div>  
        </div>
