...
{
    /**
     * Last count of unit in this suite.
     *
     * @var int|null
     */
    ...
    /**
     * The number of unit in the test suite.
     *
     * @var int
     */
    ...
    /**
     * Adds the unit from the given class to the suite.
     *
     ...
     *
     * If the named file cannot be read or there are no new unit that can be
    ...
    /**
     * Set unit groups of the test case
     *
     * @param array $groups
     */
    ...
    /**
     * Runs the unit and collects their result in a TestResult.
     *
    ...
    /**
     * Returns the unit as an enumeration.
     *
     * @return array
     */
    ...
    /**
     * Template Method that is called before the unit
    ...
    /**
     * Template Method that is called after the unit
